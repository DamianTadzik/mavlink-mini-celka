...
typedef struct __mavlink_radio_status_t {
 ...
 uint8_t noise; /*<  Local noise level*/
 uint8_t remnoise; /*<  Remote noise level*/
 ...
 * @param noise  Local noise level
 * @param remnoise  Remote noise level
